...
class Main {
    ...
    function __construct($opcion = NULL, $accion = '') {
        ...
        if (isset($parametros->type) && ($parametros->type != self::CONTENT_TYPE_AJAX_PART)) {
    ...
    function cargarInfoModulo($nombre_modulo) {
        ...
        if ($this->info_modulo->content_type == "detalle") {
            $this->info_modulo->file_path .= "app/lib/detalle/" . $nombre_modulo . ".php";
        } else {
            ...
            switch ($nombre_modulo) {
                ...
                default:
                    ...
                    $this->info_modulo->file_path = $modulo['base'];
                    $this->info_modulo->tipo = $modulo['tipo'];
                    $this->info_modulo->id_tipo = $modulo['opcion_tipo_id'];
                    $this->info_modulo->pack = $modulo['pack'];
                    if ($this->info_modulo->content_type == "detalle") {
                        $this->info_modulo->file_path .= "/lib/detalle/" . $this->info_modulo->nombre . ".php";
                    } else {
                        $this->info_modulo->file_path .= "/pack/";
