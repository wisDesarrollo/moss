...
class VentasReporte extends Reporte {
    ...
    public function __construct($db = "", $modulo = "") {
        ...
        $this->tablas = $this->nombre_tabla . ' t, fw_interlocutor i,fw_interlocutor_condicion ic, mesa m, cuenta c, fw_estado est';
        $this->campos = array(
