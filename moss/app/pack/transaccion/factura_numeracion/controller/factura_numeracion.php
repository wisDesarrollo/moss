...
class FacturaNumeracion extends Maestro {
    ...
    public function __construct($db = "", $modulo = "") {
        ...
        $campos_formulario['fecha'] = array('tipo' => 'text', 'valor' => '');
    ...
    function home() {
        ...
        $campos = array('pr.' . $this->primary_key . " AS empty", 'pr.fecha', 'pr.factura_actual', 'pr.factura_minimo','pr.factura_maximo', 'est.descripcion as Estado');
