...
class Cliente extends Interlocutor {
    ...
    public function __construct($db = "", $modulo = "") {
        ...
        $campos_formulario['nombre'] = array('tipo' => 'text', 'valor' => '', 'complemento' => '');
        ...
        $campos_formulario['num_documento'] = array('tipo' => 'text', 'valor' => '', 'complemento' => ' minlength="8"', 'label'=>'Número Documento');
    ...
    function home() {
        ...
        $campos = array('i.' . $this->primary_key . " Codigo", 'i.num_documento as documento', "concat(i.nombre,' ',i.apellido) as nombre", 'i.email', "est.descripcion as Estado");
