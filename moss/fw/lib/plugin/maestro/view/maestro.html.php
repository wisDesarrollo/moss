										...
										<tr>
											...
											<td class="input_maestro">
												<input type="<?php echo $input['tipo']; ?>" name="<?php echo $key ?>" id="<?php echo $key ?>" 
														value="<?php $valor = (isset($input['valor'])) ? $input['valor'] : ''; echo utf8_encode($valor); ?>"
														<?php $complemento = (isset($input['complemento'])) ? $input['complemento'].' ' : '';
														 echo $complemento; $checked = ($valor == 'S') ? 'checked' : ''; echo $checked . ' '; ?> >
											</td>
										</tr> <?php
										break;
									case 'hidden':
										?> <tr>
											...
											<td>
												<input type="<?php echo $input['tipo']; ?>" name="<?php echo $key ?>" id="<?php echo $key ?>" 
														 value="<?php $valor = (isset($input['valor'])) ? $input['valor'] : ''; echo $valor;?>"
														 <?php $complemento = (isset($input['complemento'])) ? $input['complemento'] : '';
														 echo $complemento; ?> >
											</td>
										</tr><?php
									...
									case 'select':
										?> <tr>
											...
											<td class="input_maestro">        
												...
												<?php 
													$complemento = (isset($input['complemento'])) ? $input['complemento'] : ''; echo $complemento;
												?> >
										...
										?> <tr>
											...
											<td class="input_maestro">
												<textarea id="<?php echo $key ?>" type="<?php echo $input['tipo']; ?>"  name="<?php echo $key ?>" value="" class="custom-input" 
													<?php $complemento = (isset($input['complemento'])) ? $input['complemento'] . ' ' : '';
										 				echo $complemento; ?> ><?php echo $input['valor']; ?>
												</textarea>
											</td>
										</tr>
										<?php
										...
										?> <tr>
												...
												<td class="input_maestro">
													<a target="_blank" onfocus="this.blur()" href="<?php echo $input['ruta'] . $input['valor'] ?>"><?php
														$descripcion = (isset($input['descripcion'])) ? $input['descripcion'] : $input['valor']; echo $descripcion;
												?></a>
												</td>
											</tr>
										<?php
						...
						<tr>
							<td>
								<?php if (in_array($value, $config['buscar'])){ ?> 
									...
									<button onclick="buscar_registro('<?php echo $maestro; ?>', '<?php echo $value; ?>', '<?php echo $entradas['condicion'][$key]; ?>'); ">Buscar</button>
								<?php } else{ ?>
